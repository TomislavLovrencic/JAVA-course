 ...
 * 
 * This class is used to test implementations from linkedList and ArrayIndexed list.
 *
 */
public class ArrayAndListDemo {
	...
	public static void main(String[] args) {
		...
		class P extends Processor {  public void process(Object o) {    System.out.println(o);  } };
		
		System.out.println("col elements:"); col.forEach(new P());
		System.out.println("col elements again:"); System.out.println(Arrays.toString(col.toArray()));
		
		System.out.println("col2 elements:"); col2.forEach(new P());
		...
		ArrayIndexedCollection col4 = new ArrayIndexedCollection(col);
		col4.add(8);
		System.out.println(Arrays.toString(col4.toArray()));
		
		LinkedListIndexedCollection nova = new LinkedListIndexedCollection(col4);
		
		nova.insert("tompa", 0);
		nova.insert("tompa", 4);
		System.out.println(Arrays.toString(nova.toArray()));
		nova.forEach(new P());
		System.out.println(nova.indexOf("tompa"));
